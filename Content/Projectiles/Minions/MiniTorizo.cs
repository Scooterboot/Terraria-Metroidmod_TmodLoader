...
namespace MetroidMod.Content.Projectiles.Minions
{
	...
	public class ChozoStaff : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.buffType = ModContent.BuffType<MiniTorizoBuff>();
	...
	public class MiniTorizo : ModProjectile
	{
		...
		private bool CheckActive(Player owner) {
			if (owner.dead || !owner.active) {
				owner.ClearBuff(ModContent.BuffType<MiniTorizoBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<MiniTorizoBuff>())) {
